...
import static com.mutong.jcommunity.util.CommunityConstant.*;
...
public class UserService {
    ...
    public Map<String, Object> register(User user) {
        ...
        // http://localhost:8080/jcommunity/activation/101/code 激活链接
     ...
     * @param password 传过来的password
     * @param expiredSeconds 传过来的时间
     * @return
     */
    ...
    public Collection<? extends GrantedAuthority> getAuthorities(int userId){
        ...
        list.add(new GrantedAuthority(){
            ...
            public String getAuthority() {
                switch (user.getType()){
                    case 1 :
                        return AUTGORITY_ADMIN;
                    case 2 :
                        return AUTGORITY_MODERATOR;
                    default :
                        return AUTGORITY_USER;
                }
            }
        });
        return list;
